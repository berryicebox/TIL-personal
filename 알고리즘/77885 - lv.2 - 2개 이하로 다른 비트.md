...
function solution(numbers) {
    const answer = numbers.map((num) => {
        ...
        // 홀수
        const odd = '0' + num.toString(2)
        const lastZero = odd.lastIndexOf('0')
        const nextMin = odd.slice(0, lastZero) + '10' + odd.slice(lastZero + 2)
        return parseInt(nextMin, 2)
    })
